 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt="WebChannelConnection";class p2 extends d2{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,n,s,o){const u=Lm();return new Promise((f,m)=>{const p=new I0;p.setWithCredentials(!0),p.listenOnce(C0.COMPLETE,()=>{try{switch(p.getLastErrorCode()){case Xc.NO_ERROR:const E=p.getResponseJson();se(Qt,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(E)),f(E);break;case Xc.TIMEOUT:se(Qt,`RPC '${e}' ${u} timed out`),m(new oe(X.DEADLINE_EXCEEDED,"Request time out"));break;case Xc.HTTP_ERROR:const S=p.getStatus();if(se(Qt,`RPC '${e}' ${u} failed with status:`,S,"response text:",p.getResponseText()),S>0){let D=p.getResponseJson();Array.isArray(D)&&(D=D[0]);const z=D==null?void 0:D.error;if(z&&z.status&&z.message){const F=function(K){const te=K.toLowerCase().replace(/_/g,"-");return Object.values(X).indexOf(te)>=0?te:X.UNKNOWN}(z.status);m(new oe(F,z.message))}else m(new oe(X.UNKNOWN,"Server responded with status "+p.getStatus()))}else m(new oe(X.UNAVAILABLE,"Connection failed."));break;default:ve()}}finally{se(Qt,`RPC '${e}' ${u} completed.`)}});const y=JSON.stringify(o);se(Qt,`RPC '${e}' ${u} sending request:`,o),p.send(n,"POST",y,s,15)})}Wo(e,n,s){const o=Lm(),u=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],f=N0(),m=O0(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(p.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(p.useFetchStreams=!0),this.Do(p.initMessageHeaders,n,s),p.encodeInitMessageHeaders=!0;const E=u.join("");se(Qt,`Creating RPC '${e}' stream ${o}: ${E}`,p);const S=f.createWebChannel(E,p);let D=!1,z=!1;const F=new m2({Fo:K=>{z?se(Qt,`Not sending because RPC '${e}' stream ${o} is closed:`,K):(D||(se(Qt,`Opening RPC '${e}' stream ${o} transport.`),S.open(),D=!0),se(Qt,`RPC '${e}' stream ${o} sending:`,K),S.send(K))},Mo:()=>S.close()}),Z=(K,te,ae)=>{K.listen(te,ue=>{try{ae(ue)}catch(be){setTimeout(()=>{throw be},0)}})};return Z(S,Ul.EventType.OPEN,()=>{z||(se(Qt,`RPC '${e}' stream ${o} transport opened.`),F.Qo())}),Z(S,Ul.EventType.CLOSE,()=>{z||(z=!0,se(Qt,`RPC '${e}' stream ${o} transport closed`),F.Ko())}),Z(S,Ul.EventType.ERROR,K=>{z||(z=!0,uo(Qt,`RPC '${e}' stream ${o} transport errored:`,K),F.Ko(new oe(X.UNAVAILABLE,"The operation could not be completed")))}),Z(S,Ul.EventType.MESSAGE,K=>{var te;if(!z){const ae=K.data[0];Ge(!!ae);const ue=ae,be=(ue==null?void 0:ue.error)||((te=ue[0])===null||te===void 0?void 0:te.error);if(be){se(Qt,`RPC '${e}' stream ${o} received error:`,be);const pe=be.status;let Oe=function(w){const C=_t[w];if(C!==void 0)return cA(C)}(pe),P=be.message;Oe===void 0&&(Oe=X.INTERNAL,P="Unknown error status: "+pe+" with message "+be.message),z=!0,F.Ko(new oe(Oe,P)),S.close()}else se(Qt,`RPC '${e}' stream ${o} received:`,ae),F.Uo(ae)}}),Z(m,D0.STAT_EVENT,K=>{K.stat===Rm.PROXY?se(Qt,`RPC '${e}' stream ${o} detected buffering proxy`):K.stat===Rm.NOPROXY&&se(Qt,`RPC '${e}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{F.$o()},0),F}}function cm(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
***************************************************************************** */var no=function(){return no=Object.assign||function(e){for(var n,s=1,o=arguments.length;s<o;s++){n=arguments[s];for(var u in n)Object.prototype.hasOwnProperty.call(n,u)&&(e[u]=n[u])}return e},no.apply(this,arguments)},uS=function(r){return{loading:r==null,value:r}},LM=function(){return function(r,e){switch(e.type){case"error":return no(no({},r),{error:e.error,loading:!1,value:void 0});case"reset":return uS(e.defaultValue);case"value":return no(no({},r),{error:void 0,loading:!1,value:e.value});default:return r}}},jM=function(r){var e=void 0,n=Y.useReducer(LM(),uS(e)),s=n[0],o=n[1],u=Y.useCallback(function(){var p=void 0;o({type:"reset",defaultValue:p})},[r]),f=Y.useCallback(function(p){o({type:"error",error:p})},[]),m=Y.useCallback(function(p){o({type:"value",value:p})},[]);return Y.useMemo(function(){return{error:s.error,loading:s.loading,reset:u,setError:f,setValue:m,value:s.value}},[s.error,s.loading,u,f,m,s.value])},zM=function(r,e,n){var s=Y.useRef(r);return Y.useEffect(function(){e(r,s.current)||(s.current=r,n&&n())}),s},BM=function(r,e){var n=!r&&!e,s=!!r&&!!e&&hM(r,e);return n||s},qM=function(r,e){return zM(r,BM,e)},HM=function(r,e){var n=jM(),s=n.error,o=n.loading,u=n.reset,f=n.setError,m=n.setValue,p=n.value,y=qM(r,u);return Y.useEffect(function(){if(!y.current){m(void 0);return}var E=CM(y.current,m,f);return function(){E()}},[y.current]),[p,o,s]},cS=function(r,e){var n=HM(r),s=n[0],o=n[1],u=n[2],f=FM(s,void 0,void 0);return[f,o,u,s]},FM=function(r,e,n){return Y.useMemo(function(){var s;return(s=r==null?void 0:r.docs.map(function(o){return o.data(e)}))!==null&&s!==void 0?s:n},[r,e])};function GM({filterUserId:r,adminUid:e}){var z;const{currentUser:n}=cs(),s=Hh(Gh,"messages"),o=Y.useRef(null),u=Y.useRef(null),f=(z=n==null?void 0:n.metadata)==null?void 0:z.creationTime,m=f?ft.fromDate(new Date(f)):ft.now(),p=JA(s,Gc(eS(Gc(Qi("senderId","==",r),Qi("receiverId","==",e)),Gc(Qi("senderId","==",e),Qi("receiverId","==",r)),Gc(Qi("senderId","==",e),Qi("receiverId","==","broadcast"))),Qi("timestamp",">=",m)),tS("timestamp","asc")),[y,E,S]=cS(p),D=()=>{var F;(F=o.current)==null||F.scrollIntoView({behavior:"smooth"})};return Y.useEffect(()=>{S&&(console.error("Firestore Error:",S),console.log("Current User UID:",n==null?void 0:n.uid))},[S]),Y.useEffect(()=>{D()},[y]),Y.useEffect(()=>{u.current&&(u.current.scrollTop=u.current.scrollHeight)},[]),E?j.jsx("div",{children:"Loading messages..."}):S?j.jsxs("div",{children:["Error loading messages: ",S.message]}):j.jsx("div",{className:"messages-container",ref:u,children:j.jsxs("div",{className:"message-list",children:[(y==null?void 0:y.length)===0?j.jsx("div",{children:"No messages yet. Start the conversation!"}):y==null?void 0:y.map(F=>{var Z;return j.jsxs("div",{className:`message ${F.senderId===(n==null?void 0:n.uid)?"sent":"received"}`,children:[F.receiverId==="broadcast"&&j.jsx("div",{className:"broadcast-badge",children:"From 🧋:"}),j.jsx("div",{className:"message-content",children:F.content}),j.jsx("div",{className:"message-time",children:(Z=F.timestamp)==null?void 0:Z.toDate().toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})})]},F.id)}),j.jsx("div",{ref:o})]})})}function KM(){const{currentUser:r}=cs(),e="Ie35osxKxPMkroz5M6jvAe2Suhf2",[n,s]=Y.useState(""),[o,u]=Y.useState(0),f=async m=>{if(m.preventDefault(),!(!r||n.trim()===""||o>=3))try{const p=r.uid===e;await aS(Hh(Gh,"messages"),{senderId:r.uid,receiverId:p?"broadcast":e,content:n,timestamp:oS(),read:!1,type:"text",isBroadcast:p}),u(y=>y+1),s("")}catch(p){console.error("Error sending message:",p)}};return j.jsx("div",{className:"message-input",children:j.jsxs("form",{onSubmit:f,children:[j.jsx("input",{value:n,onChange:m=>s(m.target.value),maxLength:100,placeholder:(r==null?void 0:r.uid)===e?"Type broadcast message...":"Type your message...",disabled:o>=3}),j.jsxs("button",{type:"submit",disabled:o>=3,className:"send-button",children:[(r==null?void 0:r.uid)===e?"Broadcast":"Send","(",3-o," left)"]})]})})}const QM=()=>{const{currentUser:r}=cs(),e=$n();return j.jsxs("div",{className:"chat-container",children:[j.jsx("header",{className:"chat-header",children:j.jsxs("div",{className:"chat-info",children:[j.jsx("h1",{className:"chat-title",children:"Chat with Cameron"}),j.jsxs("div",{className:"message-counter",children:["Messages remaining: ",3-((r==null?void 0:r.messageCount)||0)]})]})}),j.jsx("main",{className:"chat-main",children:r?j.jsxs(j.Fragment,{children:[j.jsx(GM,{filterUserId:r.uid,adminUid:"Ie35osxKxPMkroz5M6jvAe2Suhf2"}),j.jsx("div",{className:"input-container",children:j.jsx(KM,{})})]}):j.jsx("div",{className:"loading-chat",children:"Loading chat session..."})}),j.jsx("button",{className:"back-button",onClick:()=>e("/user"),children:"← Return to Dashboard"})]})},YM=Y.createContext();function $M({children:r}){const[e,n]=Y.useState(0),[s,o]=Y.useState(null);return j.jsx(YM.Provider,{value:{messageCount:e,setMessageCount:n,selectedUser:s,setSelectedUser:o},children:r})}function XM(){const{currentUser:r}=cs(),e=Hh(Gh,"messages"),n=Y.useRef(null),s=Y.useRef(null),o=JA(e,eS(Qi("receiverId","==",r==null?void 0:r.uid),Qi("senderId","==",r==null?void 0:r.uid)),tS("timestamp","asc")),[u,f,m]=cS(o),p=()=>{var y;(y=n.current)==null||y.scrollIntoView({behavior:"smooth"})};return Y.useEffect(()=>{p()},[u]),Y.useEffect(()=>{s.current&&(s.current.scrollTop=s.current.scrollHeight)},[]),f?j.jsx("div",{children:"Loading messages..."}):m?j.jsxs("div",{children:["Error loading messages: ",m.message]}):j.jsx("div",{className:"messages-container",ref:s,children:j.jsxs("div",{className:"message-list",children:[(u==null?void 0:u.length)===0?j.jsx("div",{className:"no-messages",children:"No messages yet. Start chatting!"}):u==null?void 0:u.map(y=>{var E;return j.jsxs("div",{className:`message ${y.senderId===(r==null?void 0:r.uid)?"sent":"received"}`,children:[j.jsx("div",{className:"message-content",children:y.content}),j.jsx("div",{className:"message-time",children:(E=y.timestamp)==null?void 0:E.toDate().toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})})]},y.id)}),j.jsx("div",{ref:n})]})})}function WM(){const{currentUser:r}=cs(),[e,n]=Y.useState(""),s=async o=>{if(o.preventDefault(),!(!r||e.trim()===""))try{await aS(Hh(Gh,"messages"),{senderId:r.uid,receiverId:"broadcast",content:e,timestamp:oS(),read:!1,type:"text",isBroadcast:!0}),n("")}catch(u){console.error("Error sending message:",u)}};return j.jsx("div",{className:"message-input",children:j.jsxs("form",{onSubmit:s,children:[j.jsx("input",{value:e,onChange:o=>n(o.target.value),maxLength:100,placeholder:"Type broadcast message..."}),j.jsx("button",{type:"submit",className:"send-button",children:"Broadcast"})]})})}const ZM=()=>{const{currentUser:r}=cs(),e=$n();return j.jsxs("div",{className:"chat-container",children:[j.jsx("header",{className:"chat-header",children:j.jsxs("div",{className:"chat-info",children:[j.jsx("h1",{className:"chat-title",children:"Admin Chat Console"}),j.jsx("div",{className:"message-counter",children:r?`Logged in as ${r.email}`:"Loading..."})]})}),j.jsx("main",{className:"chat-main",children:r?j.jsxs(j.Fragment,{children:[j.jsx(XM,{filterUserId:r.uid,adminUid:r.uid}),j.jsx("div",{className:"input-container",children:j.jsx(WM,{})})]}):j.jsx("div",{className:"loading-chat",children:"Loading admin session..."})}),j.jsx("button",{className:"back-button",onClick:()=>e("/admin"),children:"← Return to Dashboard"})]})},Hp="/CameronLim-Fan-Website/",JM=()=>j.jsxs(j.Fragment,{children:[j.jsxs("header",{children:[j.jsx("h1",{children:"Cameron Lim's Online Cafe"}),j.jsx("div",{style:oo.subtitleContainer,children:j.jsx("h2",{children:"Chat with Cameron Lim and his community :) 🖥️ 💬"})})]}),j.jsx(dm,{})]}),eV=({children:r})=>{const e=vo(),n=$n();return Y.useEffect(()=>{try{decodeURIComponent(e.pathname)}catch{n(Hp,{replace:!0})}},[e.pathname,n]),r},tV=()=>j.jsx(Kb,{basename:Hp,children:j.jsx(MM,{children:j.jsx($M,{children:j.jsx(eV,{children:j.jsx("div",{style:oo.container,children:j.jsx("div",{style:oo.contentContainer,children:j.jsxs(jb,{children:[j.jsxs(gn,{element:j.jsx(JM,{}),children:[j.jsx(gn,{path:"/",element:j.jsx(nV,{})}),j.jsx(gn,{path:"/signin",element:j.jsx(VM,{})}),j.jsx(gn,{path:"/createaccount",element:j.jsx(UM,{})})]}),j.jsxs(gn,{element:j.jsx(kM,{}),children:[j.jsxs(gn,{path:"/user",children:[j.jsx(gn,{index:!0,element:j.jsx(PM,{})}),j.jsx(gn,{path:"chat",element:j.jsx(QM,{})})]}),j.jsxs(gn,{path:"/admin",children:[j.jsx(gn,{index:!0,element:j.jsx(xM,{})}),j.jsx(gn,{path:"chat",element:j.jsx(ZM,{})})]})]}),j.jsx(gn,{path:"*",element:j.jsx(iV,{})})]})})})})})})}),nV=()=>j.jsxs("div",{style:oo.buttonContainer,children:[j.jsx(Xl,{to:"/signin",style:oo.button,children:"Sign In"}),j.jsx(Xl,{to:"/createaccount",style:oo.button,children:"Create Account"})]}),iV=()=>{const r=$n();return Y.useEffect(()=>r(Hp),[r]),null},oo={container:{display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center",minHeight:"100vh",padding:"10px",backgroundColor:"#ffffff"},subtitleContainer:{marginTop:"-10px",textAlign:"center",color:"#666"},buttonContainer:{display:"flex",flexDirection:"column",gap:"15px",marginTop:"30px"},button:{padding:"15px 30px",fontSize:"1.1rem",backgroundColor:"#5db1ff",color:"white",border:"none",borderRadius:"10px",cursor:"pointer",transition:"transform 0.2s, background-color 0.2s",width:"220px",textDecoration:"none",textAlign:"center",display:"flex",justifyContent:"center",alignItems:"center",":hover":{backgroundColor:"#21867a",transform:"scale(1.05)"}},contentContainer:{flex:1,display:"flex",justifyContent:"center",alignItems:"center",width:"100%",padding:"10px",flexDirection:"column"}};Kw.createRoot(document.getElementById("root")).render(j.jsx($E.StrictMode,{children:j.jsx(tV,{})}));
